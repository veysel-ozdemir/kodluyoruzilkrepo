    ...
    public static void showMessage(String str) {
        ...
        switch (str.toLowerCase()) {
            ...
            case "otel-exists":
                ...
                break;
            case "room-exists":
                message = "The room already exists. Try to enter another one.";
                title = "Caution";
                break;
            case "reservation-exists":
                message = "The reservation already exists. Try to enter another one.";
                title = "Caution";
                break;
            case "no-user":
                message = "There is no user with entered credentials.";
                title = "Caution";
                break;
            case "no-otel":
                message = "There is no otel with entered ID.";
                title = "Caution";
                break;
            case "no-room":
                message = "There is no room with entered ID.";
                title = "Caution";
                break;
            case "patika-exists":
                message = "The name already exists. Try to enter another one.";
            ...
            case "invalid-id":
                ...
                title = "Error";
                break;
            case "invalid-number-otel":
                message = "The Number and Otel ID must be positive integer.";
                title = "Error";
                break;
            case "invalid-user":
                ...
                break;
            case "invalid-otel":
                message = "There is no otel with corresponding ID.";
                title = "Error";
                break;
            case "invalid-room":
                message = "There is no room with corresponding ID.";
                title = "Error";
                break;
            case "invalid-reservation":
                message = "There is no reservation with corresponding ID.";
                title = "Error";
                break;
            ...
            case "invalid-user-type":
                message = "Invalid type entered. Enter only following options:\n- admin\n- employee";
                title = "Error";
                break;
            case "invalid-pension-type":
                message = "Invalid type entered. Enter only following options:" +
                        "\n- ultra all inclusive" +
                        "\n- all inclusive" +
                        "\n- bed and breakfast" +
                ...
                break;
            case "invalid-season":
                message = "Invalid season entered. Enter only following options:" +
                        "\n- summer" +
                        "\n- spring" +
                        "\n- winter" +
                        "\n- fall";
